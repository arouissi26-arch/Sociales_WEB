...
const menuData = [
    // --- ANTIPASTI (ENTRANTS) ---
    { id: 'bruschetta', category: 'classic', name: 'Bruschetta al Pomodoro', price: '12€', desc: 'Un clàssic fresc i cruixent per començar.', ingredients: 'pa torrat, tomàquet, all, alfàbrega, oli d’oliva', image: 'assets/bruschetta_pomodoro_1767211926577.png', nutrition: { calorias: 180, azucar: 4, sal: 0.8, proteinas: 4 }, alergenos: ['gluten'] },
    { id: 'carpaccio', category: 'classic', name: 'Carpaccio di Manzo', price: '18€', desc: 'Lleuger i elegant, amb un toc cítric.', ingredients: 'vedella laminada, ruca, parmesà, llimona', image: 'assets/carpaccio_manzo_1767211939552.png', nutrition: { calorias: 220, azucar: 1, sal: 1.2, proteinas: 28 }, alergenos: ['lactosa'] },
    { id: 'caprese', category: 'classic', name: 'Caprese Clàssica', price: '14€', desc: 'Un plat senzill i colorit originari de Capri.', ingredients: 'tomàquet, mozzarella, alfàbrega, oli d’oliva', image: 'assets/caprese_classica_1767211954139.png', nutrition: { calorias: 280, azucar: 3, sal: 0.9, proteinas: 18 }, alergenos: ['lactosa'] },
    { id: 'prosciutto', category: 'classic', name: 'Prosciutto e Melone', price: '16€', desc: 'Contrapunt perfecte entre dolç i salat.', ingredients: 'pernil curat, meló', image: 'assets/prosciutto_melone_1767211968253.png', nutrition: { calorias: 190, azucar: 12, sal: 2.1, proteinas: 15 }, alergenos: [] },
    { id: 'focaccia', category: 'classic', name: 'Focaccia al Romaní', price: '8€', desc: 'Pa esponjós i aromàtic, típic de Ligúria.', ingredients: 'massa de pa, oli d’oliva, romaní', image: 'assets/focaccia_romani_1767211982175.png', nutrition: { calorias: 320, azucar: 2, sal: 1.5, proteinas: 8 }, alergenos: ['gluten'] },
    { id: 'olive', category: 'classic', name: 'Olive all’Ascolana', price: '10€', desc: 'Olives farcides i arrebossades, cruixents per fora.', ingredients: 'olives grans, carn picada, pa ratllat', image: 'assets/olive_ascolana_1767211997378.png', nutrition: { calorias: 290, azucar: 1, sal: 1.8, proteinas: 12 }, alergenos: ['gluten', 'huevo'] },
    { id: 'antipasto-mare', category: 'classic', name: 'Antipasto di Mare', price: '20€', desc: 'Amanida marinera fresca i lleugera.', ingredients: 'pop, musclos, calamars, llimona', image: 'assets/antipasto_mare_1767212011417.png', nutrition: { calorias: 180, azucar: 2, sal: 1.4, proteinas: 22 }, alergenos: ['marisco'] },
    { id: 'crostini', category: 'classic', name: 'Crostini Toscani', price: '12€', desc: 'Intens i rústic, típic de la Toscana.', ingredients: 'pa torrat, paté de fetge, ceba', image: 'assets/crostini_toscani_1767212026350.png', nutrition: { calorias: 240, azucar: 1, sal: 1.1, proteinas: 14 }, alergenos: ['gluten'] },
    ...
    // --- PRIMI PIATTI ---
    { id: 'carbonara', category: 'classic', name: 'Spaghetti alla Carbonara', price: '18€', desc: 'El clàssic romà, cremós sense nata.', ingredients: 'ou, pecorino, guanciale, pebre negre', image: 'assets/spaghetti_carbonara_1767212093654.png', nutrition: { calorias: 520, azucar: 2, sal: 1.8, proteinas: 22 }, alergenos: ['gluten', 'huevo', 'lactosa'] },
    { id: 'arrabbiata', category: 'classic', name: 'Penne all’Arrabbiata', price: '15€', desc: 'Picant i saborós.', ingredients: 'tomàquet, all, bitxo, oli d’oliva', image: 'assets/penne_arrabbiata_1767212107053.png', nutrition: { calorias: 380, azucar: 6, sal: 0.9, proteinas: 12 }, alergenos: ['gluten'] },
    { id: 'lasanya', category: 'classic', name: 'Lasanya a la Bolonyesa', price: '20€', desc: 'Capes de pasta tendra amb salsa de carn.', ingredients: 'pasta, ragú, beixamel, parmesà', image: 'assets/lasanya_bolonyesa_1767212121373.png', nutrition: { calorias: 580, azucar: 5, sal: 2.1, proteinas: 28 }, alergenos: ['gluten', 'lactosa', 'huevo'] },
    { id: 'risotto-bolets', category: 'classic', name: 'Risotto als Bolets', price: '22€', desc: 'Cremós i aromàtic.', ingredients: 'arròs arborio, bolets, parmesà', image: 'assets/risotto_bolets_1767219328704.png', nutrition: { calorias: 420, azucar: 2, sal: 1.2, proteinas: 10 }, alergenos: ['lactosa'] },
    { id: 'gnocchi', category: 'classic', name: 'Gnocchi al Pesto', price: '16€', desc: 'Suau i molt fragant.', ingredients: 'patata, alfàbrega, pinyons, parmesà', image: 'assets/gnocchi_pesto_1767219342535.png', nutrition: { calorias: 460, azucar: 3, sal: 1.4, proteinas: 14 }, alergenos: ['gluten', 'lactosa', 'frutos_secos'] },
    { id: 'tagliatelle', category: 'classic', name: 'Tagliatelle al Ragù Bolonyès', price: '19€', desc: 'Recepta tradicional de Bolonya.', ingredients: 'pasta fresca, ragú, tomàquet', image: 'assets/tagliatelle_ragu_1767219356880.png', nutrition: { calorias: 540, azucar: 4, sal: 1.6, proteinas: 24 }, alergenos: ['gluten', 'huevo'] },
    { id: 'ravioli', category: 'classic', name: 'Ravioli de Ricotta i Espinacs', price: '18€', desc: 'Delicat i suau.', ingredients: 'pasta farcida, ricotta, espinacs, mantega i sàlvia', image: 'assets/ravioli_ricotta_1767219369318.png', nutrition: { calorias: 420, azucar: 3, sal: 1.1, proteinas: 18 }, alergenos: ['gluten', 'huevo', 'lactosa'] },
    { id: 'trofie', category: 'classic', name: 'Trofie al Pesto Genovès', price: '17€', desc: 'Especialitat típica de Ligúria.', ingredients: 'pasta trofie, pesto, patates, mongetes tendres', image: 'assets/trofie_pesto.jpg', nutrition: { calorias: 440, azucar: 4, sal: 1.0, proteinas: 12 }, alergenos: ['gluten', 'frutos_secos'] },
    { id: 'vongole', category: 'classic', name: 'Spaghetti alle Vongole', price: '24€', desc: 'Lleuger i mariner.', ingredients: 'cloïsses, all, vi blanc, julivert', image: 'assets/spaghetti_vongole.jpg', nutrition: { calorias: 380, azucar: 2, sal: 1.9, proteinas: 20 }, alergenos: ['gluten', 'marisco'] },
    ...
    // --- SECONDI PIATTI ---
    { id: 'cacciatora', category: 'classic', name: 'Pollastre a la Cacciatora', price: '22€', desc: 'Guisat rústic i saborós.', ingredients: 'pollastre, tomàquet, olives, vi negre', image: 'assets/pollastre_cacciatora.jpg', nutrition: { calorias: 420, azucar: 5, sal: 1.8, proteinas: 38 }, alergenos: [] },
    { id: 'saltimbocca', category: 'classic', name: 'Saltimbocca a la Romana', price: '26€', desc: 'Tendra i molt aromàtica.', ingredients: 'vedella, pernil, sàlvia', image: 'assets/saltimbocca.jpg', nutrition: { calorias: 380, azucar: 1, sal: 2.2, proteinas: 42 }, alergenos: [] },
    { id: 'fiorentina', category: 'classic', name: 'Bistecca alla Fiorentina (1kg)', price: '65€', desc: 'Carn a la graella, sucosa i tradicional.', ingredients: 'entrecot gruixut de vedella, sal, oli', image: 'assets/fiorentina.jpg', nutrition: { calorias: 850, azucar: 0, sal: 2.5, proteinas: 95 }, alergenos: [] },
    { id: 'parmigiana', category: 'classic', name: 'Parmigiana d’Albergínia', price: '18€', desc: 'Capa sobre capa, al forn, molt saborosa.', ingredients: 'albergínia, tomàquet, mozzarella, parmesà', image: 'assets/parmigiana.jpg', nutrition: { calorias: 320, azucar: 8, sal: 1.4, proteinas: 14 }, alergenos: ['lactosa'] },
    { id: 'ossobuco', category: 'classic', name: 'Ossobuco a la Milanesa', price: '28€', desc: 'Melós i ric en sabor.', ingredients: 'galta de vedella, vi blanc, verdures', image: 'assets/ossobuco.jpg', nutrition: { calorias: 480, azucar: 3, sal: 1.9, proteinas: 45 }, alergenos: ['gluten'] },
    { id: 'mandonguilles', category: 'classic', name: 'Mandonguilles en Salsa', price: '18€', desc: 'Un clàssic reconfortant.', ingredients: 'carn picada, pa, tomàquet, espècies', image: 'assets/mandonguilles.jpg', nutrition: { calorias: 420, azucar: 6, sal: 1.7, proteinas: 28 }, alergenos: ['gluten', 'huevo'] },
    ...
    // --- DOLCI ---
    { id: 'tiramisu', category: 'postres', name: 'Tiramisù', price: '8€', desc: 'Clàssic italià, cremós i intens.', ingredients: 'mascarpone, cafè, cacau, ous', image: 'assets/tiramisu.jpg', nutrition: { calorias: 420, azucar: 28, sal: 0.3, proteinas: 8 }, alergenos: ['lactosa', 'huevo', 'gluten'] },
    { id: 'panna-cotta', category: 'postres', name: 'Panna Cotta amb Fruits Vermells', price: '8€', desc: 'Suau, sedosa i refrescant.', ingredients: 'nata, vainilla, gelatina', image: 'assets/panna_cotta.png', nutrition: { calorias: 340, azucar: 24, sal: 0.2, proteinas: 5 }, alergenos: ['lactosa'] },
    { id: 'cannoli', category: 'postres', name: 'Cannoli Sicilians', price: '9€', desc: 'Cruixents i cremosos alhora.', ingredients: 'ricotta, sucre, taronja confitada', image: 'assets/cannoli.jpg', nutrition: { calorias: 380, azucar: 22, sal: 0.4, proteinas: 10 }, alergenos: ['gluten', 'lactosa', 'frutos_secos'] },
    { id: 'gelat', category: 'postres', name: 'Gelat Artesà Italià', price: '7€', desc: 'Cremós i sabor intens.', ingredients: 'llet, sucre, ingredients naturals', image: 'assets/gelat.png', nutrition: { calorias: 220, azucar: 18, sal: 0.1, proteinas: 4 }, alergenos: ['lactosa'] },
    ...
    { id: 'torta-nonna', category: 'postres', name: 'Torta della Nonna', price: '9€', desc: 'Tradicional i molt aromàtica.', ingredients: 'crema pastissera, pinyons, pasta brisa', image: 'assets/torta_della_nonna.jpg', nutrition: { calorias: 360, azucar: 20, sal: 0.3, proteinas: 7 }, alergenos: ['gluten', 'huevo', 'lactosa', 'frutos_secos'] },
    { id: 'profiteroles', category: 'postres', name: 'Profiteroles amb Xocolata', price: '9€', desc: 'Boles farcides banyades en xocolata.', ingredients: 'pasta choux, crema, xocolata', image: 'assets/profiteroles.jpg', nutrition: { calorias: 440, azucar: 32, sal: 0.4, proteinas: 6 }, alergenos: ['gluten', 'huevo', 'lactosa'] },
    { id: 'sfogliatella', category: 'postres', name: 'Sfogliatella Napolitana', price: '5€', desc: 'Cruixent per fora, suau per dins.', ingredients: 'pasta de full, ricotta, sèmola', image: 'assets/sfogliatella.jpg', nutrition: { calorias: 280, azucar: 16, sal: 0.5, proteinas: 6 }, alergenos: ['gluten', 'lactosa'] },
    { id: 'affogato', category: 'postres', name: 'Affogato al Caffè', price: '7€', desc: 'Senzill i deliciós.', ingredients: 'gelat de vainilla, cafè espresso', image: 'assets/affogato.jpg', nutrition: { calorias: 180, azucar: 14, sal: 0.1, proteinas: 3 }, alergenos: ['lactosa'] },
    { id: 'cassata', category: 'postres', name: 'Cassata Siciliana', price: '10€', desc: 'Colorida i dolça, molt festiva.', ingredients: 'pa de pessic, ricotta dolça, fruita confitada', image: 'assets/cassata.png', nutrition: { calorias: 480, azucar: 38, sal: 0.3, proteinas: 8 }, alergenos: ['gluten', 'lactosa', 'frutos_secos'] },

    // --- MENÚ VEGÀ ---
    // Antipasti
    { id: 'bruschetta-v', category: 'vegan', name: 'Bruschetta al Pomodoro (Vegà)', price: '12€', desc: 'Entrada fresca i cruixent.', ingredients: 'pa torrat, tomàquet, all, alfàbrega, oli d’oliva', image: 'assets/bruschetta_vegan.png', nutrition: { calorias: 180 }, alergenos: ['gluten'] },
    { id: 'caprese-v', category: 'vegan', name: 'Caprese Vegana', price: '14€', desc: 'La clàssica caprese sense productes animals.', ingredients: 'tomàquet, mozzarella vegana, alfàbrega', image: 'assets/caprese_vegan.jpg', nutrition: { calorias: 200 }, alergenos: [] },
    { id: 'carpaccio-v', category: 'vegan', name: 'Carpaccio de Remolatxa', price: '14€', desc: 'Cruixent i fresc.', ingredients: 'remolatxa cuita, ruca, nous, llimona', image: 'assets/carpaccio_remolatxa.jpg', nutrition: { calorias: 150 }, alergenos: ['frutos_secos'] },
    { id: 'focaccia-v', category: 'vegan', name: 'Focaccia al Romaní (Vegà)', price: '8€', desc: 'Esponjosa i aromàtica.', ingredients: 'massa de pa, oli d’oliva, romaní', image: 'assets/focaccia_vegan.jpg', nutrition: { calorias: 320 }, alergenos: ['gluten'] },
    { id: 'olives-v', category: 'vegan', name: 'Olives Farcides Veganes', price: '9€', desc: 'Cruixents i plenes de sabor.', ingredients: 'olives, pèsols, ametlles', image: 'assets/olives_vegan.png', nutrition: { calorias: 220 }, alergenos: ['frutos_secos'] },
    { id: 'caponata-v', category: 'vegan', name: 'Caponata Siciliana', price: '12€', desc: 'Estofat de verdures sicilià.', ingredients: 'albergínia, tomàquet, api, olives', image: 'assets/caponata_vegan.jpg', nutrition: { calorias: 240 }, alergenos: [] },
    { id: 'hummus-v', category: 'vegan', name: 'Hummus Italià', price: '10€', desc: 'Suau i cremós amb pinyons.', ingredients: 'cigrons, llimona, pinyons', image: 'assets/hummus_vegan.jpg', nutrition: { calorias: 300 }, alergenos: ['frutos_secos'] },
    { id: 'arancini-v', category: 'vegan', name: 'Arancini Vegans', price: '11€', desc: 'Boletes d’arròs farcides de verdures.', ingredients: 'arròs, verdures, pa ratllat', image: 'assets/arancini_vegan.jpg', nutrition: { calorias: 350 }, alergenos: ['gluten'] },
    { id: 'burrata-v', category: 'vegan', name: 'Burrata Vegana', price: '15€', desc: 'Cremosa amb pesto vegà.', ingredients: 'tofu, tomàquets cherry, pesto vegà', image: 'assets/burrata_vegan.png', nutrition: { calorias: 280 }, alergenos: ['frutos_secos', 'soja'] },
    { id: 'ensalada-v', category: 'vegan', name: 'Ensalada Mediterrània', price: '12€', desc: 'Nutritiva i fresca.', ingredients: 'cigrons, mongetes, tomàquet, pebrot', image: 'assets/ensalada_mediterrania.jpg', nutrition: { calorias: 250 }, alergenos: [] },
    ...
    { id: 'risotto-setas-v', category: 'vegan', name: 'Risotto de Bolets Vegà', price: '22€', desc: 'Cremós sense lactis.', ingredients: 'arròs, bolets, brou vegetal', image: 'https://images.unsplash.com/photo-1633337474564-1d9478ca4e2e?w=500&h=500&fit=crop', nutrition: { calorias: 400 }, alergenos: [] },
    { id: 'lasanya-v', category: 'vegan', name: 'Lasanya Vegana', price: '19€', desc: 'Capes saboroses, 100% vegetal.', ingredients: 'pasta, llenties, beixamel vegana', image: 'https://images.unsplash.com/photo-1619895092538-128341789043?w=500&h=500&fit=crop', nutrition: { calorias: 450 }, alergenos: ['gluten'] },
    { id: 'gnocchi-v', category: 'vegan', name: 'Gnocchi amb Salsa de Tomàquet', price: '16€', desc: 'Suau i reconfortant.', ingredients: 'patata, farina, tomàquet', image: 'https://images.unsplash.com/photo-1548369937-47519962c11a?w=500&h=500&fit=crop', nutrition: { calorias: 410 }, alergenos: ['gluten'] },
    ...
    // Secondi Vegans
    { id: 'pollastre-v', category: 'vegan', name: 'Pollastre Vegà Cacciatora', price: '20€', desc: 'Seitán/Tofu guisat rústic.', ingredients: 'seitan/tofu, tomàquet, olives', image: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=500&h=500&fit=crop', nutrition: { calorias: 350 }, alergenos: ['gluten', 'soja'] },
    { id: 'seitan-llimo-v', category: 'vegan', name: 'Escalopines de Seitan', price: '19€', desc: 'Fines i cítriques.', ingredients: 'seitan, llimona, oli', image: 'https://images.unsplash.com/photo-1512058564366-18510be2db19?w=500&h=500&fit=crop', nutrition: { calorias: 320 }, alergenos: ['gluten'] },
    ...
    { id: 'ossobuco-v', category: 'vegan', name: 'Ossobuco Vegà', price: '20€', desc: 'Estofat de llegums.', ingredients: 'llenties, pastanaga, tomàquet', image: 'https://images.unsplash.com/photo-1515516969-d4008cc6241a?w=500&h=500&fit=crop', nutrition: { calorias: 380 }, alergenos: [] },
    { id: 'mandonguilles-v', category: 'vegan', name: 'Mandonguilles Veganes', price: '17€', desc: 'Cruixents i tendres.', ingredients: 'llenties/cigrons, tomàquet', image: 'https://images.unsplash.com/photo-1607532941433-304659e8198a?w=500&h=500&fit=crop', nutrition: { calorias: 340 }, alergenos: [] },
    ...
    { id: 'calamars-v', category: 'vegan', name: 'Calamars Vegans Farcits', price: '19€', desc: 'Inspirat en el tradicional.', ingredients: 'xampinyons/tofu, herbes', image: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=500&h=500&fit=crop', nutrition: { calorias: 300 }, alergenos: ['soja'] },
    ...
    { id: 'cannoli-v', category: 'vegan', name: 'Cannoli Vegans', price: '9€', desc: 'Cruixent i dolç.', ingredients: 'ricotta tofu, fruita', image: 'https://images.unsplash.com/photo-1551024601-569d6e3c8e29?w=500&h=500&fit=crop', nutrition: { calorias: 360 }, alergenos: ['soja'] },
    ...
    { id: 'sfogliatella-v', category: 'vegan', name: 'Sfogliatella Vegana', price: '6€', desc: 'Cruixent.', ingredients: 'pasta full vegana, tofu', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=500&h=500&fit=crop', nutrition: { calorias: 300 }, alergenos: ['gluten', 'soja'] },
    { id: 'affogato-v', category: 'vegan', name: 'Affogato Vegà', price: '7€', desc: 'Intens.', ingredients: 'gelat vegà, cafè', image: 'https://images.unsplash.com/photo-1572490122747-3968b75cc699?w=500&h=500&fit=crop', nutrition: { calorias: 180 }, alergenos: [] },
    { id: 'cassata-v', category: 'vegan', name: 'Cassata Vegana', price: '10€', desc: 'Festiva.', ingredients: 'ricotta tofu, fruita confitada', image: 'https://images.unsplash.com/photo-1565958011703-44f9829ba187?w=500&h=500&fit=crop', nutrition: { calorias: 400 }, alergenos: ['soja'] },
    ...
    // --- INFANTIL ---
    { id: 'spaghetti-kids', category: 'infantil', name: 'Mini Spaghetti Bolognese', price: '8€', desc: 'Pasta amb salsa de tomàquet i carn. Porció adaptada.', image: 'assets/spaghetti_kids.jpg', nutrition: { calorias: 320 }, alergenos: ['gluten'] },
    { id: 'pizza-kids', category: 'infantil', name: 'Pizza Margherita Petita', price: '7€', desc: 'Tomàquet, mozzarella i alfàbrega.', image: 'assets/pizza_kids.jpg', nutrition: { calorias: 280 }, alergenos: ['gluten', 'lactosa'] },
    { id: 'nuggets-kids', category: 'infantil', name: 'Nuggets de Pollastre', price: '9€', desc: 'Amb patates fregides i ketchup.', image: 'assets/nuggets_kids.png', nutrition: { calorias: 380 }, alergenos: ['gluten', 'huevo'] },
    { id: 'gelat-kids', category: 'infantil', name: 'Gelat de 3 Boles', price: '5€', desc: 'Xocolata, vainilla i maduixa.', image: 'assets/gelat_kids.jpg', nutrition: { calorias: 240 }, alergenos: ['lactosa'] },
];
